...
const categoryPosts = allPosts.filter(p => p.url.includes('/column/'))
...
<h1 style="text-align: center; margin-top: 32px; margin-bottom: 24px; font-size: 2rem;">평론</h1>

<p style="color: var(--vp-c-text-2); text-align: center; font-size: 1rem; margin-bottom: 60px; line-height: 1.6;">
  세상 돌아가는 꼴에 대한 아주 개인적인 생각입니다.
</p>
